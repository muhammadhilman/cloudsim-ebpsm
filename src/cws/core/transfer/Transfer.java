...
public class Transfer {
    ...
    /** The job this transfer transfers files to*/
    private Job toJob;
    
    /** The job this transfer transfers files from*/
    private Job fromJob;
     ...
     */
    public Transfer(Port source, Port destination, Link link, long dataSize, int owner, CloudSimWrapper cloudsim, Job toJob, Job fromJob) {
        this.id = next_id++;
        this.src = source;
