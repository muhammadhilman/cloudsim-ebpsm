...
public abstract class StaticAlgorithm extends Algorithm implements Provisioner, Scheduler, VMListener, JobListener {
    ...
    private void submitDAG(DAG dag) {
        ...
        DAGJob dagJob = new DAGJob(dag, getEnsembleManager().getId(), 0.0);
    ...
    private void prepareEnvironment() {
        ...
        WorkflowEngine engine = new WorkflowEngineSeparateRPSched(this, this, getBudget(), getDeadline(), getCloudsim());
